...
<header class="bg-green-800 text-white shadow">
  <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
    <div class="flex items-center space-x-3">
       <img src="logo.png" alt="Logo Kemenag" class="w-10 h-10">    <h1 class="text-lg font-bold">KUA Pitu Riase</h1>
    </div>
...
<main class="max-w-6xl mx-auto px-6 py-10">
  ...
  <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
    <?php if (!empty($data)): ?>
      ...
      foreach ($reversed as $i => $item):
        $realIndex = count($data) - 1 - $i;
      ?>
        <div class="bg-white rounded-lg overflow-hidden shadow hover:shadow-lg transition-all">
          ...
          <div class="p-4">
            ...
            <a href="berita_detail.php?id=<?= $realIndex ?>" class="text-sm text-green-700 hover:underline">
              Baca Selengkapnya →
            </a>
          </div>
        </div>
